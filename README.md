...
| --- | --- | --- | --- | --- | --- | --- |
| [Pindo 能力研究与记忆灯产品实验](projects/pindo-capability-research/README.md) | [查看原库](https://github.com/LunarXuan/Pindo) | 已完成 | 验证 Pindo 如何用传统图像处理把图片或旧图纸转成品牌拼豆色号、用量与制作图，确认其构建与核心流程可用，并明确网格识别、Focus/PDF 接线、依赖安全和许可边界；研究页另展示 One、Nine、Constellation 三种独立提出的记忆灯概念。 | `image-processing`、`craft`、`pixel-art`、`product-research`、`memory-light`、`emotional-product` | 2026-08-31 | [在线查看](https://yydshly.github.io/0830_codex_project/demos/pindo-capability-research/#life-product-lines) |
...
| [ai-design-skills 能力与原理研究](projects/ai-design-skills-research/README.md) | [查看原库](https://github.com/elayadesign/ai-design-skills) | 已完成 | 结论：这是给大模型使用的通用落地页约束与检查清单，不提供独有组件或高级效果，对当前强模型的能力增量有限；保留 Skill 封装方法，研究结项。 | `ai-skill`、`web-design`、`landing-page`、`prompt-engineering`、`design-system` | 2026-08-31 | [在线查看](https://yydshly.github.io/0830_codex_project/demos/ai-design-skills-research/) |
